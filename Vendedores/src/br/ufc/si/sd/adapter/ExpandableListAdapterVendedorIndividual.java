...
public class ExpandableListAdapterVendedorIndividual extends BaseExpandableListAdapter{
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		ImageView foto = (ImageView) convertView.findViewById(R.id.tv_foto_produto_vendedor_individual);
		Bitmap bitMapFoto = converterBlobParaImagem(produto.getFoto());
	...
	public static Bitmap converterBlobParaImagem(byte[] bytes) { 
		System.out.println("exception "+String.valueOf(bytes));
		try{ 
		ByteArrayInputStream imageStream = new ByteArrayInputStream(bytes); 
		Bitmap bmp = BitmapFactory.decodeStream(imageStream); 
		Log.i("script", "Converteu");
