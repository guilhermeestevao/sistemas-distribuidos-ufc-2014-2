...
import br.ufc.si.sd.ListaProdutosVendedor.DownloadJsonAsyncTask;
...
public class ListaProdutosPorVendedor extends Activity {
	...
	public class DownloadJsonAsyncTask extends AsyncTask<String, Void, List<Produto>>{
		...
		protected void onPreExecute() {
			...
			super.onPreExecute();
			dialog = ProgressDialog.show(ListaProdutosPorVendedor.this, "Aguarde", "Buscando produtos...");
		}
		...
		protected void onPostExecute(List<Produto> result) {
			...
			if(result.size() > 0){
				...
				expListAdap = new ExpandableListAdapter(result, ListaProdutosPorVendedor.this);
				listView.setAdapter(expListAdap);
			}else{
				AlertDialog.Builder builder = new AlertDialog.Builder(ListaProdutosPorVendedor.this).setTitle("Atencao") .setMessage("Não foi possivel acessar essas informções...") .setPositiveButton("OK", null); 
				builder.create().show();
			}
		}
	...
	public class DeletaProdutoAsyncTask extends AsyncTask<Produto, Void, String>{
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			dialog = ProgressDialog.show(ListaProdutosPorVendedor.this, "Aguarde", "Apagando produto...");
		}
		...
		protected void onPostExecute(String result) {
			...
			dialog.dismiss();
			AlertDialog.Builder builder = new AlertDialog.Builder(ListaProdutosPorVendedor.this).setTitle("Atencao") .setMessage(result) .setPositiveButton("OK", null); 
			builder.create().show();
		}	
	}
}
